                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control" maxlength="100" placeholder="Nombre Del Proveedor" required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<?php
  ...
  require 'footer.php';
?>
<script type="text/javascript" src="scrips/proveedor.js"></script>
<?php 
} 
ob_end_flush();
?>